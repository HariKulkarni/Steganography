...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+8748896869</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">datahiding@gmail.com</a></p>
			<p class="contact-agile1"><strong>Address :</strong> KSRDPR UNIVERSITY, GADAG, KARANATAKA</p>
...
<!-- /contact -->
			<div class="copy">
		        <p>© 2022 Datahiding . All Rights Reserved | Design by <a href="index.php">VIJAYALAKSHMI</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
